      ...
      <div class="container-fluid">
               ...
               <div class="card-body">
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="privacy_policy">Add Privacy Policy</label>
                    <textarea class="form-control form-control-sm" name="privacy_policy" id="privacy_policy" required=""></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
        ...
        <div class="col-md-6">
            ...
            <div class="card-body">
                ...
                <a href="<?=base_url();?>index.php/adminlogin/deletepolicy/<?=$records[0]['id'];?>" class="btn btn-xs btn-default" onclick="return confirm('Are you sure to delete this?');"><i class="fas fa-trash"></i></a>
                <?php }?>
            </div>
            </div>
        </div>
