          ...
          <div class="col-lg-6">
            <div class="card">
              ...
              <div class="card-body p-0">
                 <form action="<?=site_url('vendor/communication');?>" role="form" id="myForm" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="card-body">
              ...
              <div class="card-body p-0">
                <table class="table table-striped">
                  ...
                  <?php if($records){ for($i=0;$i<count($records);$i++){?>
                    <tr>
                    <th><?=$i+1;?></th>
                    <th><?php if($records[$i]['from_id'] == 1){echo 'From :Admin';}elseif($records[$i]['to_id'] == 1){ echo 'To :Admin';}?> (<?=$records[$i]['msg'];?>)</th>
