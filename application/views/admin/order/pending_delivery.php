                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo ($records[$i]['delivery_status'])?'<button class="btn btn-danger btn-sm">'.$records[$i]['delivery_status'].'</button>':'<a href="'.base_url().'index.php/order/order_delivery/'.$records[$i]['order_id'].'" class="btn btn-primary btn-sm" title="Deliver Order" onclick="return confirm("Are you sure");">Delivered</a>&nbsp;<a href="'.base_url().'index.php/order/cancelorder/'.$records[$i]['order_id'].'" class="btn btn-warning btn-sm" title="Cancel Order" onclick="return confirm("Are you sure");">Cancel Order</a>';?></td> 
