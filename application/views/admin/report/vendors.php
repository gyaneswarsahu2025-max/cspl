                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        ...
                        <?php }else{ ?>
                          <a href="javascript:void(0)" class="btn btn-sm btn-primary">Active</a>
                          <a href="<?=site_url('report/edit_vendor/'.$records[$i]['user_id']);?>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                        <?php } ?>                          
                      </td>
                    </tr>
                  <?php } }else{ ?>
